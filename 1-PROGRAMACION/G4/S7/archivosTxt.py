archivo1 = open('TextoPrueba.txt') #así abre de solo lectura
...
# for i in archivo1:
#    print(i)
print(archivo1.readline()) # lee todo o n caracteres

print(archivo1.readlines()) # lee lineas
print(archivo1.read()) # se leen los primeros 10 caracteres # lee varias lineas y devuelve una lista
# se leen los primeros 10 caracteres
